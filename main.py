...
class GameWindow(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        with open("./racegame/tracks/Redbullring/redbullring.json", 'r') as f:
        ...
        self.game = Game(40, 100, track_data['track_limits'], track_data['reward_gates'], track_data['start_pos']['x'], track_data['start_pos']['y'], track_data['start_pos']['heading'], self)
